...
@section('content')
    <div class="h-[74px] bg-white border-b border-slate-200 flex items-center gap-3.5 px-8 shrink-0">
        <a href="{{ route('admin.students.index') }}" class="w-10 h-10 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center">
        ...
        <div class="text-lg font-extrabold text-navy-900">Ubah Siswa — {{ $student->name }}</div>
    </div>
