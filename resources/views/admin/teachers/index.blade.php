...
@section('content')
    ...
    <div class="flex-1 p-8 overflow-auto">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden">
            <div class="grid grid-cols-[1.4fr_1.4fr_1fr_1.4fr_0.8fr_1fr] gap-3.5 px-6 py-3 bg-slate-50 text-[11px] font-bold text-slate-400 uppercase tracking-wide">
                <div>Guru</div><div>Email</div><div>Peran</div><div>Kelas Binaan</div><div>Status</div><div class="text-right">Aksi</div>
            </div>

            @forelse ($teachers as $teacher)
                <div class="grid grid-cols-[1.4fr_1.4fr_1fr_1.4fr_0.8fr_1fr] gap-3.5 px-6 py-3.5 items-center border-t border-slate-100">
