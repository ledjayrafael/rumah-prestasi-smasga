                            ...
                            <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden">
                                <div class="overflow-x-auto">
                                    <div class="min-w-[720px]">
                                        <div class="grid {{ auth()->user()->isAdmin() ? 'grid-cols-[0.4fr_1.6fr_1fr_1.2fr_0.8fr]' : 'grid-cols-[1.6fr_1fr_1.2fr_0.8fr]' }} gap-3.5 px-6 py-3 bg-slate-50 text-[11px] font-bold text-slate-400 uppercase tracking-wide items-center">
                                            @if (auth()->user()->isAdmin())
                                                <div>
                                        ...
                                        @foreach ($students as $student)
                                            ...
                                            <div class="grid {{ auth()->user()->isAdmin() ? 'grid-cols-[0.4fr_1.6fr_1fr_1.2fr_0.8fr]' : 'grid-cols-[1.6fr_1fr_1.2fr_0.8fr]' }} gap-3.5 px-6 py-3.5 items-center border-t border-slate-100 hover:bg-slate-50/60 transition-colors">
                                                @if (auth()->user()->isAdmin())
                                                    <div>
